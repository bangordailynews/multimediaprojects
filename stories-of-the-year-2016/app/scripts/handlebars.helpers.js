...
Handlebars.registerHelper('multimedia', function(options) {
    ...
    switch (this.filetype) {
      ...
      case 'youtube' :
        ...
        case 'google_map':
            return '<div class="rich-media photo size-' + this.size + ' orientation-' + this.orientation + '">' +
                    '<a href="https://www.google.com/maps/d/embed?mid=1KzKQyG6JMBOZ0ZexXXCUZ2wL-tc">' +
                '<iframe class="lazy" alt="' + this.caption + '" src="https://www.google.com/maps/d/embed?mid=1KzKQyG6JMBOZ0ZexXXCUZ2wL-tc" width="100%" height="480"></iframe>' +
                    '</a>' +
                this.captionFormatted +
                '</div>';
            break;
